$(document).ready(function () {
    ...
    var URL_GET_ALL_GROUPS = "/api/get-all-units-measure/";
    var URL_BASE_GET_GROUP_DETAILS = "/api/get-units-measure-details/";
    var URL_BASE_UPDATE_GROUP = "/api/update-units-measure/";
    var URL_POST_NEW_GROUP = "/api/create-units-measure/";
    var URL_BASE_DELETE_GROUP = "/api/delete-units-measure/";
    var sorting = "asc";
