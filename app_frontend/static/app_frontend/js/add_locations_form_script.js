$(document).ready(function () {
    ...
    var URL_GET_ALL_GROUPS = "/api/get-all-locations/";
    var URL_BASE_GET_GROUP_DETAILS = "/api/get-location-details/";
    var URL_BASE_UPDATE_GROUP = "/api/update-location/";
    var URL_POST_NEW_GROUP = "/api/create-location/";
    var URL_BASE_DELETE_GROUP = "/api/delete-location/";
    var sorting = "asc";
