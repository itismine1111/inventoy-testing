$(document).ready(function () {
    ...
    var URL_GET_ALL_GROUPS = "/api/get-all-suppliers/";
    var URL_BASE_GET_GROUP_DETAILS = "/api/get-supplier-details/";
    var URL_BASE_UPDATE_GROUP = "/api/update-supplier/";
    var URL_POST_NEW_GROUP = "/api/create-supplier/";
    var URL_BASE_DELETE_GROUP = "/api/delete-supplier/";
    var sorting = "asc";
