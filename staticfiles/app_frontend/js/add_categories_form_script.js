$(document).ready(function () {
    ...
    var URL_GET_ALL_GROUPS = "/api/get-all-categories/";
    var URL_BASE_GET_GROUP_DETAILS = "/api/get-category-details/";
    var URL_BASE_UPDATE_GROUP = "/api/update-category/";
    var URL_POST_NEW_GROUP = "/api/create-category/";
    var URL_BASE_DELETE_GROUP = "/api/delete-category/";
    var sorting = "asc";
